  ...
  return (
    <form name="contact" method="POST" data-netlify="true" className="flex justify-center items-center flex-col w-full">
      ...
      <p className="w-96 h-18">
        ...
        <br />
        <input type="text" name="name" id="name" className="w-full py-2 px-4 border-2 border-black rounded-lg focus:bg-gray-100 hover:drop-shadow-xl focus:drop-shadow-xl"/>
      </p>
      <p className="w-96 h-18 mt-1">
        ...
        <br />
        <input type="email" name="email" id="email" className="w-full py-2 px-4 border-2 border-black rounded-lg focus:bg-gray-100 hover:drop-shadow-xl focus:drop-shadow-xl"/>
      </p>
