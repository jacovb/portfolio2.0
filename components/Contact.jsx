  ...
  return (
    <div className="container min-h-screen snap-start flex justify-between items-center mx-auto px-4 md:px-8 lg:px-12 w-full">
      <section id="contact" className="w-full mt-20">
        ...
        <p className="text-gray-500 mt-10 mb-5 w-full max-w-3xl">Get in touch</p>
        <div className="flex flex-row">
          <ContactForm />
          <div className="flex flex-col justify-center items-center">
            <div className="flex flex-col items-center justify-center">
              <div className="h-12 w-12 border-2 border-gray-500 rounded-full flex items-center justify-center">
                <FontAwesomeIcon icon={faEnvelope} className="h-6 text-gray-500" />
              </div>
              <div className="mt-2 font-medium text-lg text-gray-500">vbiljon@gmail.com</div>
            </div>
            <div className="flex flex-col items-center justify-center mt-12">
              <div className="h-12 w-12 border-2 border-gray-500 rounded-full flex items-center justify-center">
                <FontAwesomeIcon icon={faPhone} className="h-6 text-gray-500"/>
              </div>
              <div className="mt-2 font-medium text-lg text-gray-500">074 7007 4039</div>
            </div>
          </div>
        </div>
      </section>
