    ...
    <>
      ...
      <div className="flex flex-wrap mt-4 w-96 lg:w-full">
        ...
        <div className="flex flex-col items-center justify-center w-24 h-20">
          ...
          <h3 className="text-md font-semibold mt-1">Javascript</h3>
        </div>
        <div className="flex flex-col items-center justify-center w-20 h-20">
          <FontAwesomeIcon icon={faReact} style={{color: "#61DBFB"}} className="h-8"/>
          <h3 className="text-md font-semibold mt-1">React</h3>
        </div>
        <div className="flex flex-col items-center justify-center w-20 h-20">
