  ...
  return (
    <div className="container min-h-screen snap-start flex justify-between items-center mx-auto px-4 md:px-8 lg:px-12 w-full">
      <section id="about" className="w-full mt-10">
        ...
        <div className="my-12 w-full max-w-3xl z-10 flex">
          <div className="flex-col">
            <h2 className="text-xl font-bold text-black">From a background in Architecture, I like to:</h2>
            <ul className="text-gray-600 text-lg list-disc mt-4">
              <li className="ml-6">build things</li>
              <li className="ml-6">solve problems</li>
              <li className="ml-6">learn</li>
            </ul>
            <h2 className="text-xl font-bold text-black mt-4">Why Software Development?</h2>
            <ul className="text-gray-600 text-lg list-disc mt-4">
              <li className="ml-6">mixing creativity and logical thinking</li>
              <li className="ml-6">unlimited prospects for career development</li>
